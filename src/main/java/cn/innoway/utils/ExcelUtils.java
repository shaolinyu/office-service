...
public class ExcelUtils {
    ...
    public static void main(String[] args){
        ...
        excelUtils.OpenExcel("C:\\Users\\shao\\Desktop\\test.xlsx" , false);
        excelUtils.setBlackGroudPrituce();
        excelUtils.CloseExcel("D:\\"+System.currentTimeMillis()+"_ok.xls");
     ...
     * @param visible readonly 是否只读方式打开
     */
    ...
    /**
     * 另存为文档并关闭excel文档
     * @param filePath 含义不明 （关闭是否保存？默认false）
     */
